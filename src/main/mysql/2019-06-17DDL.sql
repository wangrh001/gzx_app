...
create table cfg_bridge_cust_certi_type
(
	id int not null
		primary key,
...
create table cfg_bridge_cust_relation_type
(
	id int not null
		primary key,
	name varchar(255) null
...
create table cfg_bridge_estate_type
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_bridge_mortgage_busi_type
(
	id int not null
		primary key,
	name varchar(255) null
...
create table cfg_bridge_mortgage_state
(
	id int not null
		primary key,
	name varchar(255) null
...
create table cfg_bridge_mortgage_type
(
	id int not null
		primary key,
	name varchar(255) null
...
create table cfg_bridge_order_acception_bank_code
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_bridge_order_busi_type
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_bridge_order_certi_type
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_bridge_order_city
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_bridge_order_marriage
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_bridge_order_pay_type
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_bridge_order_product_id
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_bridge_order_public_fund_bank
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_bridge_order_sex
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_bridge_order_watch_bank
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_bridge_property_state
(
	id int not null
		primary key,
	name varchar(255) null
...
create table cfg_bridge_property_type
(
	id int not null
		primary key,
	name varchar(255) null
...
create table cfg_new_load_condition
(
	id int not null
		primary key,
	name varchar(255) null
...
(
	...
	need_condition varchar(255) null,
...
create table cfg_original_loan_bank
(
	id int not null
		primary key,
	name varchar(255) null
...
create table cfg_original_loan_foreclosure_type
(
	id int not null
		primary key,
	name varchar(255) null
...
create table cfg_original_loan_organ_type
(
	id int not null
		primary key,
	name varchar(255) null
...
create table cfg_original_loan_type
(
	id int not null
		primary key,
	name varchar(255) null
...
create table cfg_reminder_log_type
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_reminder_log_way
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table cfg_reminder_type
(
	id int not null
		primary key,
	name varchar(255) not null
...
create table t_bridge_bank_account
(
	id bigint auto_increment
		primary key,
	account_certi_code varchar(255) null,
	...
	update_time datetime null,
	updator int null,
	new_loan_id bigint null,
	bank_id_name varchar(255) null
)
;

create table t_bridge_customer
(
	id bigint auto_increment
		primary key,
	...
	updator int null,
	state int null,
	certi_type_name varchar(255) null,
	cust_type_name varchar(255) null,
	company_name varchar(255) null,
	company_phone varchar(255) null,
	license_code varchar(255) null,
	low_person varchar(255) null
)
;

create table t_bridge_mortgage
(
	...
	order_id bigint null,
	order_product_id bigint null,
	propertyno varchar(255) null,
	property_name varchar(255) null,
	property_state int null,
	property_type int null,
	property_use varchar(255) null,
	register_price varchar(255) null,
	square float null,
	update_time datetime null,
	updator int null,
	state int null,
	can_loan_amount decimal(19,2) null,
	percent int null,
	property_type_name varchar(255) null
)
;

create table t_bridge_new_loan_info
(
	id bigint auto_increment
		primary key,
	approve_amount decimal(19,2) null,
	contact_name varchar(255) null,
	contact_phone varchar(255) null,
	if_other_part int null,
	loan_condition int null,
	loan_type int null,
	order_id bigint null,
	order_product_id bigint null,
	organ_code int null,
	...
	update_time datetime null,
	updator bigint null,
	loan_condition_name varchar(255) null,
	organ_type_name varchar(255) null
)
;

create table t_bridge_order
(
	id bigint auto_increment
		primary key,
	acception_account_name varchar(255) null,
	acception_bank_code int null,
	acception_branch_bank varchar(255) null,
	acception_cardno varchar(255) null,
	address varchar(255) null,
	busi_type int null,
	captial_watch_account varchar(255) null,
	captial_watch_amount decimal(19,2) null,
	certi_code varchar(255) null,
	certi_type int null,
	city int null,
	commission decimal(19,2) null,
	consult_fee decimal(19,2) null,
	create_time datetime null,
	creator bigint null,
	due_fee decimal(19,2) null,
	fee decimal(19,2) null,
	fee_allowance decimal(19,2) null,
	first_amount decimal(19,2) null,
	front_money decimal(19,2) null,
	loan_amount decimal(19,2) null,
	loan_days int null,
	loan_name varchar(255) null,
	marriage int null,
	order_code varchar(255) null,
	original_captial_interest decimal(19,2) null,
	original_load_amount decimal(19,2) null,
	pay_type int null,
	percent decimal(19,2) null,
	phoneno varchar(255) null,
	plan_loan_date datetime null,
	product_id int null,
	project_name varchar(255) null,
	public_fund_account_bank varchar(255) null,
	public_fund_amount decimal(19,2) null,
	public_fund_bank int null,
	public_fund_cardno varchar(255) null,
	public_fund_name decimal(19,2) null,
	sex int null,
	state int null,
	total_approve_amount decimal(19,2) null,
	total_deal_price decimal(19,2) null,
	total_estimate_price decimal(19,2) null,
	total_register_price decimal(19,2) null,
	update_time datetime null,
	updator bigint null,
	watch_account_bank varchar(255) null,
	watch_bank int null,
	watch_unfreeze_account varchar(255) null,
	approve_id varchar(255) null,
	comments varchar(255) null,
	demand_amount decimal(19,2) null,
	demand_date datetime null,
	last_amount decimal(19,2) null,
	last_organ_name varchar(255) null,
	next_amount decimal(19,2) null,
	next_organ_name varchar(255) null,
	order_state int null,
	saler_id bigint null,
	saler_name varchar(255) null,
	organ_amount decimal(19,2) null,
	self_amount decimal(19,2) null,
	sign_date datetime null,
	plan_organ_amount decimal(19,2) null,
	first_trial_no_cause varchar(255) null,
	second_trial_no_cause varchar(255) null,
	third_trial_no_cause varchar(255) null
)
;

create table t_bridge_original_loan_info
(
	id bigint auto_increment
		primary key,
	...
	amount decimal(19,2) null,
	bank_code int null,
	capital_interest decimal(19,2) null,
	contact_name varchar(255) null,
	contact_phone varchar(255) null,
	end_date datetime null,
	foreclosure_type int null,
	has_pre_storage int null,
	order_id bigint null,
	order_product_id bigint null,
	organ_code int null,
	organ_type int null,
	prostorage_days int null,
	type int null,
	create_time datetime null,
	creator bigint null,
	state int null,
	update_time datetime null,
	updator bigint null,
	foreclosure_type_name varchar(255) null,
	organ_type_name varchar(255) null,
	organ_code_name varchar(255) null,
	type_name varchar(255) null
)
;

create table t_bridgecbs_bridge_order
(
	id bigint auto_increment
		primary key,
	acception_account_name varchar(255) null,
...
create table t_cbs_new_loan_info
(
	id bigint auto_increment
		primary key,
	approve_amount decimal(19,2) null,
...
(
	...
	approve_id varchar(255) null,
	last_org_type int null,
	comments varchar(255) null,
	last_amount decimal(19,2) null,
	last_org_name varchar(255) null,
	next_amount decimal(19,2) null,
	next_org_name varchar(255) null
)
;
...
create table t_cbs_original_loan_info
(
	id bigint auto_increment
		primary key,
	accountno varchar(255) null,
...
(
	...
	title_certificateno varchar(500) null,
	...
	next_organ_type int null,
	apply_tel varchar(255) null,
	house_area int null,
	mortgage_num int null,
	organ_amount decimal(19,2) null,
	self_amount decimal(19,2) null,
	sign_date datetime null
)
...
(
	...
	update_time datetime null,
	updator bigint null,
	who_object varchar(255) null,
	can_modify_role_set varchar(255) null,
	can_see_role_set varchar(255) null,
	need_button varchar(255) null,
	if_need varchar(255) null
)
;

create table t_util_reminder
(
	id bigint auto_increment
		primary key,
	create_time datetime null,
	creator bigint null,
	logic_condition varchar(255) null,
	name varchar(255) null,
	say_what varchar(255) null,
	state int null,
	type int null,
	update_time datetime null,
	updator bigint null,
...
create table t_util_reminder_log
(
	id bigint auto_increment
		primary key,
	create_time datetime null,
