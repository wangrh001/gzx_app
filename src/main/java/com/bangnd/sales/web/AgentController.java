...
@RequestMapping("/agent/home")public String home(Model model,AgentSearchForm agentSearchForm){
...
@RequestMapping("/agent/toAdd")public String toAdd(Model model){Agent agent = new Agent();
